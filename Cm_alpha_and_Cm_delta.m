...
IAS_kts_Cm_d  = mean(xlsread(datasheet, 'E75:E76'));
hp_ft_Cm_d   = mean(xlsread(datasheet, 'D75:D76'));
TAT_C_Cm_d  = mean(xlsread(datasheet, 'M75:M76'));
Delta_de_Cm_d  = convang((xlsread(datasheet, 'G75')-xlsread(datasheet, 'G76')), 'deg', 'rad');


[h_Cm_d, V_Cm_d, T_Cm_d, p_Cm_d, rho_Cm_d] = ISA_converted(hp_ft_Cm_d, ...
    IAS_kts_Cm_d, TAT_C_Cm_d)
