...
FU_ShortPeriod = FU(t_ShortPeriod);           % [kg]
hp0    = hp(t_ShortPeriod);               % pressure altitude in the stationary flight condition [m]
V0     = TAS(t_ShortPeriod);              % true airspeed in the stationary flight condition [m/sec]
alpha0 = deg2rad(AOA(t_ShortPeriod));     % angle of attack in the stationary flight condition [rad]
th0    = deg2rad(Pitch(t_ShortPeriod));   % pitch angle in the stationary flight condition [rad]
m      = Wi - FU_ShortPeriod;             % [kg]
